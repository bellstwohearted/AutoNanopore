...
def event_detection(filePath,args):
    ...
    theta = args.theta
    direc_flag = args.signal_direction  # 0 for positive-going signals and 1 for negative-going
...
if __name__=="__main__":
    ...
    parser.add_argument("--signal_direction", type=int, default=0, help="Direction of original signal")
    parser.add_argument("--theta", type=float, default=1.5, help="multiplication of IQR")
    parser.add_argument("--window_size", type=int, default=30, help="length of segmentation(ms)")
